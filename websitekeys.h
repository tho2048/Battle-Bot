...
// <!-- NEW: Autonomous moves -->
// <div class="section">
//     <h2>Autonomous Moves</h2>
//     <h3>Drive Distance (m)</h3>
//     <input type="number" id="distInput" value="0.50" step="0.10">
//     <button class="button" onclick="driveMeters()">Drive X m</button>
//     <br>
//     <button class="button" onclick="rot90(90)">Rotate +90°</button>
//     <button class="button" onclick="rot90(-90)">Rotate -90°</button>
// </div>
...
// Target: <span id="targetVal">0</span>°<br>
// LeftPWM: <span id="lpwm">0</span>%<br>
// RightPWM: <span id="rpwm">0</span>%<br>
// X: <span id="posX">0</span> m<br>
// Y: <span id="posY">0</span> m<br>
// Dist: <span id="distTot">0</span> m
// </div>
...
//     let m = parseFloat(document.getElementById("distInput").value) || 0;
//     let cm = Math.round(m * 100); // send centimeters as integer
//     fetch(`/DRIVEM?value=${cm}`);
// }

// function rot90(delta) {
//     // delta should be +90 or -90
//     fetch(`/ROT90?value=${delta}`);
// }
...
//     .then(t => {
//         let v = t.split(",");
//         // yaw, target, lpwm, rpwm, x, y, dist
//         if (v.length >= 7) {
//             document.getElementById("yawVal").innerHTML   = v[0];
//             document.getElementById("targetVal").innerHTML= v[1];
//             document.getElementById("lpwm").innerHTML     = v[2];
//             document.getElementById("rpwm").innerHTML     = v[3];
//             document.getElementById("posX").innerHTML     = v[4];
//             document.getElementById("posY").innerHTML     = v[5];
//             document.getElementById("distTot").innerHTML  = v[6];
//         }
//     });
// }, 100);
